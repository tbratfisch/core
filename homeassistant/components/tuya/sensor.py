...
SENSORS: dict[str, tuple[TuyaSensorEntityDescription, ...]] = {
    ...
    "qxj": (
        ...
        TuyaSensorEntityDescription(
            key=DPCode.BATTERY_STATE_1,
            name="Battery State 1",
            translation_key="battery_state_1",
            icon="mdi:battery",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        TuyaSensorEntityDescription(
            key=DPCode.BATTERY_STATE_2,
            name="Battery State 2",
            translation_key="battery_state_2",
            icon="mdi:battery",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        TuyaSensorEntityDescription(
            key=DPCode.BATTERY_STATE_3,
            name="Battery State 3",
            translation_key="battery_state_3",
            icon="mdi:battery",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        TuyaSensorEntityDescription(
            key=DPCode.COM_INDEX,
            name="Comfort Index",
            translation_key="com_index",
        ),
        TuyaSensorEntityDescription(
            key=DPCode.DEW_TEMP_POINT,
            name="Dew Temperature Point",
            translation_key="dew_temperature_point",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
            key=DPCode.FAULT_TYPE,
            name="Fault Type",
            translation_key="fault_type",
            entity_category=EntityCategory.DIAGNOSTIC,
        ),
        TuyaSensorEntityDescription(
            key=DPCode.FEELLIKE_TEMP,
            name="Feellike Temperature",
            translation_key="feellike_temperature",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            ...
            translation_key="temperature_indoor",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            key=DPCode.WIND_CHILL_INDEX,
            name="Wind Chill Index",
            translation_key="wind_chill_index",
            device_class=SensorDeviceClass.TEMPERATURE,
            state_class=SensorStateClass.MEASUREMENT,
        ),
        TuyaSensorEntityDescription(
        ...
        TuyaSensorEntityDescription(
            ...
            name="Windspeed Gust",
            translation_key="wind_speed_gust",
            device_class=SensorDeviceClass.WIND_SPEED,
            state_class=SensorStateClass.MEASUREMENT,
            icon="mdi:windsock",
        ),

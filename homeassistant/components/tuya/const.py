...
class DPCode(StrEnum):
    ...
    ATMOSPHERIC_PRESSURE = "atmospheric_pressture" # no typo here, it's in the API
    ...
    BATTERY_STATE_1 = "battery_state_1"  # Battery state
    BATTERY_STATE_2 = "battery_state_2"  # Battery state
    BATTERY_STATE_3 = "battery_state_3"  # Battery state

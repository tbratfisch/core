...
class DPCode(StrEnum):
    ...
    ATMOSPHERIC_PRESSURE = "atmospheric_pressture"  # no typo here, it's remote
    ...
    BATTERY_STATE_1 = "battery_state_1"  # Battery state 1
    BATTERY_STATE_2 = "battery_state_2"  # Battery state 2
    BATTERY_STATE_3 = "battery_state_3"  # Battery state 3
    ...
    BRIGHT_UNIT_CONVERT = "bright_unit_convert"
    ...
    HUMIDITY_OUTDOOR_1 = "humidity_outdoor_1"  # Outdoor humidity #1
    HUMIDITY_OUTDOOR_2 = "humidity_outdoor_2"  # Outdoor humidity #2
    HUMIDITY_OUTDOOR_3 = "humidity_outdoor_3"  # Outdoor humidity #2
    ...
    RAIN_24H = "rain_24h"
    RAIN_RATE = "rain_rate"
    RAIN_UNIT_CONVERT = "rain_unit_convert"
    ...
    TEMP_CURRENT_EXTERNAL = "temp_current_external"  # Current external temperature in °C
    TEMP_CURRENT_EXTERNAL_1 = "temp_current_external_1"  # Current external temperature in °C
    TEMP_CURRENT_EXTERNAL_2 = "temp_current_external_2"  # Current external temperature in °C
    TEMP_CURRENT_EXTERNAL_3 = "temp_current_external_3"  # Current external temperature in °C
    ...
    WIND_CHILL_INDEX = "wind_chill_index"
    WIND_DIR360 = "wind_dir360"
